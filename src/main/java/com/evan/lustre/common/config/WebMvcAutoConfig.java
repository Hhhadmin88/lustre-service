package com.evan.lustre.common.config;

import com.evan.lustre.security.interceptor.LoginInterceptor;
...
@Slf4j
@Configuration
@ComponentScan(basePackages = "com.evan.lustre.controller")
