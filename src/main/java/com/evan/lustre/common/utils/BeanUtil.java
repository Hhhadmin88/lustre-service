...
import com.evan.lustre.common.exception.BeanUtilExceptionAbstract;
...
public class BeanUtil {
     ...
     * @throws BeanUtilExceptionAbstract if newing target instance failed or copying failed
     */
    @Nullable
    public static <T> T transformFrom(@Nullable Object source, @NonNull Class<T> targetClass) {
        ...
        try {
            ...
            throw new BeanUtilExceptionAbstract("Failed to new " + targetClass.getName() + " instance or copy properties", e);
        }
    }
     ...
     * @throws BeanUtilExceptionAbstract if copying failed
     */
    public static void updateProperties(@NonNull Object source, @NonNull Object target) {
        ...
        try {
            ...
            throw new BeanUtilExceptionAbstract("Failed to copy properties", e);
        }
    }
